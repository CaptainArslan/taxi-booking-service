    ...
    <section class="page-header blog-details">
        <div class="container">
            <div class="page-header-info text-center">
                <h4>Blog Details</h4>
                <h2>Fresh Startup Ideas For <br> Digital Business</h2>
                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="post-details">
                        ...
                        <ul class="post-navigation">
                            <li><a href="blog-details"><span><i class="las la-angle-left"></i>Previous</span>How To Start Initiating An Startup In Few Days.</a></li>
                            <li><a href="blog-details"><span>Next<i class="las la-angle-right"></i></span>Fresh Startup Ideas For Digital Business.</a></li>
                        </ul>
                        <!--Post Navigations-->
