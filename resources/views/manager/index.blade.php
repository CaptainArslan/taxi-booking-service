                                                    ...
                                                    <div class="col-md-12 mt-3 mb-2">
                                                        ...
                                                        <div class="d-flex mt-1" style="justify-content: center; align-items: center;">
                                                            <div class="form-check form-check-primary col-lg-4">
                                                                ...
                                                                <label class="form-check-label" for="manager_payment">Manager</label>
                                                            </div>
                                                            <div class="col-lg-8 d-flex">
                                                                ...
                                                                <div class="col-lg-6 px-1">
                                                                    <input class="form-control" type="date" id="manager_trail_end_date" placeholder="Select date" name="manager_trail_end_date">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="d-flex mt-1" style="justify-content: center; align-items: center;">
