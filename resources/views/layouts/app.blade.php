    ...
    <section class="pricing-section bg-grey bd-bottom padding">
        <div class="container">
            ...
            <ul class="nav pricing-tab-menu" id="pricing-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="town-taxt" data-bs-toggle="tab" data-bs-target="#town-taxi-content" type="button" role="tab" aria-controls="town-taxi-content" aria-selected="false">Town
                        Taxi</button>
                </li>
                <li class="nav-item" role="presentation">
                    ...
                    <div class="post-card">
                        ...
                        <div class="post-content-wrap">
                            ...
                            <div class="post-content">
                                <h3>
                                    <a href="blog-details" class="hover">How to start initiating an startup in few
                                        days.</a>
                                </h3>
