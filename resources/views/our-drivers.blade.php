            ...
            <div class="container">
                <div class="nav-menu-inner">
                    ...
                    <div class="menu-right-item">
                        ...
                        <a href="book-taxi" class="menu-btn">Book a Taxi</a>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 padding-15">
                    <div class="team-item">
                        ...
                        <div class="team-content">
                            <h3><a href="driver-details">Félix Lengyel</a></h3>
                            <h4>BMW X5 2008</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 padding-15">
                    <div class="team-item">
                        ...
                        <div class="team-content">
                            <h3><a href="driver-details">Henry Nathan</a></h3>
                            <h4>Mercedes‑Benz</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 padding-15">
                    <div class="team-item">
                        ...
                        <div class="team-content">
                            <h3><a href="driver-details">Brandon Larned</a></h3>
                            <h4>Hyundai 2022</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 padding-15">
                    <div class="team-item">
                        ...
                        <div class="team-content">
                            <h3><a href="driver-details">Sasha Hostyn</a></h3>
                ...
                <div class="col-lg-3 col-md-6 padding-15">
                    <div class="team-item">
                        ...
                        <div class="team-content">
                            <h3><a href="driver-details">Fede Sarmiento</a></h3>
                            <h4>Toyota XCorola</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 padding-15">
                    <div class="team-item">
                        ...
                        <div class="team-content">
                            <h3><a href="driver-details">Mauricio Fernández</a></h3>
                            <h4>Hyundai 2022</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 padding-15">
                    <div class="team-item">
                        ...
                        <div class="team-content">
                            <h3><a href="driver-details">Javier F. Arébalo</a></h3>
                            <h4>Mercedes‑Benz</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 padding-15">
                    <div class="team-item">
                        ...
                        <div class="team-content">
                            <h3><a href="driver-details">Martín Nonalaya</a></h3>
                            <h4>BMW X5 2008</h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-3 col-md-6 sm-padding">
                        <div class="footer-item footer-list">
                            ...
                            <ul class="footer-links">
                                <li><a href="book-taxi">Taxi Booking</a></li>
                                <li><a href="faqs">Help Center</a></li>
                                <li><a href="about-us">Privacy and Policy</a></li>
                                <li><a href="about-company">Terms of Use</a></li>
